...
builder.Services.AddDbContext<DevEventsDBContext>(e => e.UseSqlServer(connectionString));
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        {
            Name = "EdgarHygino",
            Email = "edgar.hygino@gmail.com",
            Url = new Uri("https://www.linkedin.com/in/edgar-hygino/")
        }
    });
